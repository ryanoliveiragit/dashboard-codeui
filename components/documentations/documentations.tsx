        ...
        <div className="rounded-md bg-accent border-accent p-6 flex gap-4 justify-between">
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-1 ">
              ...
              <h1 className="text-sm text-muted-foreground">Design, wireframe, StyleGuide, UI/UX</h1>
            </div>
          </div>
        ...
        <div className="rounded-md bg-accent border-accent p-6 flex gap-4 justify-between">
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-1 ">
              ...
              <h1 className="text-sm text-muted-foreground">Boas práticas, padrões de commit, Storybook</h1>
            </div>
          </div>
          <Button className="flex gap-1 items-center">
            Download
